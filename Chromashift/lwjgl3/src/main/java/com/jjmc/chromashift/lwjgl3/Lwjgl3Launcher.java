package com.jjmc.chromashift.lwjgl3;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3Application createApplication() {
        return new Lwjgl3Application(new ChromashiftGame(), getDefaultConfiguration());
    }

    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        Lwjgl3ApplicationConfiguration configuration = new Lwjgl3ApplicationConfiguration();
        configuration.setTitle("Chromashift");
        // Note: HdpiMode not available in some LibGDX versions; rely on backbuffer-aware UI math instead.
